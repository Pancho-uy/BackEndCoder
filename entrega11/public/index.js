...
document.getElementById("chat").style.background =
  "#efe7dd url( 'https://img.freepik.com/foto-gratis/tono-blanco-espacio-diseno-fondo-textura-papel-arrugado-blanco_1258-78696.jpg?w=2000')";
...
const render = (data) => {
  let content = data
    ...
    .map((item) => {
      return `<p> <strong>${item.author.id} el </strong> <span style="color:brown;">[${new Date().toLocaleString()}]</span> dijo: ${item.messages.msg} `;
    })
    .join(" ");
